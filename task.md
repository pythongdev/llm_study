...
| Thay đổi cái gì | Câu lệnh để thấy thay đổi | Ở đâu |
|---|---|---|
| Bỏ `⚠️` trước `project_preparation/00-scope.md §4.4`, giữ nguyên con trỏ và cả câu còn lại | `git diff -- design/BA/04-yeu-cau.md` | [design/BA/04-yeu-cau.md](design/BA/04-yeu-cau.md) › §1 bảng đầu ra › hàng `Đ4`, dòng 22 |

**Đạt khi:** đúng **3** file trong commit (`design/BA/04-yeu-cau.md` + `task.md` + `finding.md`); diff chỉ đụng **một** dòng; [F-31](finding.md#f-31) chuyển `✅ ĐÓNG` kèm vế `**Bài học giữ lại:**`.
...
**`design/BA/04-yeu-cau.md`** · sàn **T2** · ⬜ chưa đo — task chưa làm
...
**ĐẠT khi:** ba hàng xanh **và** bốn cổng lane BA ở [design/BA/04-yeu-cau.md §2](design/BA/04-yeu-cau.md) còn xanh. · **Đã thử làm đỏ:** ⬜ chưa
